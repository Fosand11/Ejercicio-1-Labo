...
int main()
{
    ...
    ll.addFront(1, "Julio Pablo", "Administrador");
    ll.addFront(2, "Antonio Campos", "Administrador");
    ll.addFront(3, "Juana Arce", "Administrador");
    ll.addFront(4, "Jonathan Scamella", "Trabajador");
    ll.addFront(5, "Rafael Castro", "Trabajador");
    ll.addFront(6, "Valeria Diaz", "Trabajador");
    ll.addFront(7, "Zara Molina", "Cliente");
    ll.addFront(8, "Gustavo Mejia", "Cliente");

    //  Anadir al final
    ll.addBack(9, "Julian Castro", "Administrador");
    ll.addBack(10, "Jurgen Klopp", "Administrador");
    ll.addBack(11, "Natalia Villalta", "Trabajador");
    ll.addBack(12, "Benito Martinez", "Trabajador");
    ll.addBack(13, "Jose Acosta", "Cliente");
    ll.addBack(14, "Jemima Perez", "Cliente");
